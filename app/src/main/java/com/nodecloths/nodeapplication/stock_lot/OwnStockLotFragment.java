...
import static com.nodecloths.nodeapplication.helper.Apis.myStockLotList;
import static com.nodecloths.nodeapplication.helper.Apis.stokLotGet;
import static com.nodecloths.nodeapplication.helper.Common.TAG;

/**
 * A simple {@link Fragment} subclass.
 */
public class OwnStockLotFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_own_stock_lot, container, false);
    ...
    private void getPostItem() {
        ...
        stockLotLists.clear();
        StringRequest request = new StringRequest(Request.Method.GET, myStockLotList+Common.phoneNum, new Response.Listener<String>() {
            @Override
