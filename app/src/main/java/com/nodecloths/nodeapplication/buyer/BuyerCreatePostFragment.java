 ...
 */
public class BuyerCreatePostFragment extends Fragment {
    ...
    private String et_fab_name,et_fab_type,et_fab_g_min,et_fab_g_max,et_wei_min,et_wei_miax,et_message;

    private FirebaseDatabase firebaseDatabase;
    public BuyerCreatePostFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_buyer_creat_post, container, false);
        ...
        if (isClicked == 0) {
            submitButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    et_fab_g_min = etFabricGsmMin.getText().toString();
                    et_fab_g_max = etFabricGsmMax.getText().toString();
                    et_wei_min = etWeightMin.getText().toString();
                    et_wei_miax = etWeightMax.getText().toString();
                    et_message = edMessage.getText().toString();
                    ...
                    if (et_wei_miax.isEmpty()) {
                        etWeightMax.setError("");
                    }
                    if (et_message.isEmpty()) {
                        edMessage.setError("");
                    } else if (!et_fab_type.isEmpty() && !et_fab_g_min.isEmpty() && !et_fab_g_max.isEmpty() &&
                            !et_wei_min.isEmpty() && !et_wei_miax.isEmpty() && !et_message.isEmpty()) {
                        if (type.equals("image")){
                            uploadImage(bitmap);

                        }else {
                            dataPost(et_fab_name, et_fab_type, et_fab_g_min, et_fab_g_max, et_wei_min
                                    , et_wei_miax, et_message,colorName,haxCode,type);
    ...
    private void dataPost(final String fab_name, final String fab_type, final String fab_g_min, final String fab_g_max,
                          final String wei_min, final String wei_max, final String message, final String colorNAME, final String haxCODE,final String imageName) {

        StringRequest request = new StringRequest(Request.Method.POST, Apis.postItem, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() {
                ...
                MyData.put("extra_one", imageName);
                MyData.put("extra_two", "0");
                MyData.put("extra_three", "0");
                MyData.put("extra_four", "0");
                return MyData;
            }
        };
    ...
    private void seveOnfirebase(){
        ...
        reference.child("fab_type").setValue("Fab: "+et_fab_type+", Weight: "+et_wei_min+"-"+et_wei_miax+" kg");
        reference.child("fab_name").setValue(et_fab_name+" fabric is needed.");
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == PICK_IMAGE) {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                Log.d("TANVIR", String.valueOf(path));
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        ...
                        if (jsonObject.toString().toLowerCase().contains("1")) {
                            dataPost(et_fab_name, et_fab_type, et_fab_g_min, et_fab_g_max, et_wei_min
                                    , et_wei_miax, et_message,type,"#000000",imgname+".jpg");
                        }
